...
(* [string_to_pos s] is the 0-based tuple of positions that [s]
   represents. Examples: string_to_pos "e4" is (4, 3). string_to_pos
   "h8" is (7, 7). string_to_pos "k9" raises Malformed. Raises:
   Malformed if pos is not a valid position. *)
